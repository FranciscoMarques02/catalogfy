  ...
  <div class="container">
    ...
    <div class="row mt-5">
      ...
      <?php foreach ($tabela as $linha) { ?>
        <div class="col-7">
          <img class="rounded mx-auto d-block" src="fotos/<?= $linha['foto'] ?>" width="400px" height="400px"/>
        </div>

        <div class="col-5">
          <h2><?= $linha['nome'] ?></h2>
          <p><?= $linha['descricao'] ?></p>
          <h1 class="display-6">R$ <?= $linha['preco'] ?></h1>
          <a href="index.php"><small class="btn btn-primary">Voltar</small></a>
        </div>
      <?php } ?>
